...
return [
  ...
  'image_optimizers' => [
    ...
    Spatie\ImageOptimizer\Optimizers\Pngquant::class => [
      ...
      '--quality=85-90', // quality range
      '--skip-if-larger', // don't save if larger than original
    ],
  ...
  /*
    * Defines the directory where media files are stored relative to the
    * disk root directory.
    */
  'directory_name' => 'media',

  /*
    * The path where asset paths will start from.
    */
  'asset_url' => '/storage',

  /*
   * The path where to store converted images.
   */
